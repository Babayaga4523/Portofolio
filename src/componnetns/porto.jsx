...
const CERTIFICATES = [
  ...
  { title: 'Studi Independen Bersertifikat MSIB Part 2', issuer: 'Kemendikbudristek RI', date: '2024', image: '/certificates/stupen 2.png', description: 'Sertifikasi Tambahan Program Studi Independen MSIB Kemendikbudristek RI.', type: 'Kemendikbudristek' },
  ...
  { title: 'Building Website using HTML5', issuer: 'Universitas Gunadarma', date: '2023', image: '/certificates/Building Website using HTML 5.png', description: 'Perancangan dan pembangunan struktur aplikasi web menggunakan standar semantic HTML5.', type: 'Web Dev' },
  { title: 'Java for Intermediate', issuer: 'Universitas Gunadarma', date: '2023', image: '/certificates/JAVA FOR INTERMEDIATE.png', description: 'Pemrograman berorientasi objek (OOP), struktur data, dan penanganan logikaJava tingkat menengah.', type: 'Programming' },
  { title: 'Java Programming for Beginner', issuer: 'Universitas Gunadarma', date: '2022', image: '/certificates/JAVA PROGRAMMING FOR BEGINNER.png', description: 'Dasar-dasar sintaksis pemrograman Java, algoritma dasar, dan logika pemrograman.', type: 'Programming' },
  { title: 'Local Area Network (LAN) using Cisco Router', issuer: 'Universitas Gunadarma / Cisco', date: '2023', image: '/certificates/LOCAL AREA NETWORK USING CISCO ROUTER.png', description: 'Konfigurasi jaringan LAN, subnetting, dan penyetingan router Cisco.', type: 'Networking' },
  { title: 'Wide Area Network (WAN) using Cisco Router', issuer: 'Universitas Gunadarma / Cisco', date: '2023', image: '/certificates/WIDE AREA NETWORK USING CISCO ROUTER FOR INTERMEDIATE.png', description: 'Manajemen jaringan skala luas (WAN), routing protocol, dan troubleshooting infrastruktur Cisco.', type: 'Networking' },
  { title: 'Fundamental Desktop Programming', issuer: 'Universitas Gunadarma', date: '2022', image: '/certificates/FUNDAMENTAL DESKTOP PROGRAMMING.png', description: 'Pengembangan aplikasi desktop GUI, event-driven programming, dan integrasi database.', type: 'Programming' },
  { title: 'Fundamental Networking', issuer: 'Universitas Gunadarma', date: '2022', image: '/certificates/FUNDAMENTAL NETWORKING.png', description: 'Konsep dasar jaringan komputer, OSI layer, TCP/IP, dan arsitektur komunikasi data.', type: 'Networking' },
  ...
  { title: 'Figma Fundamentals & UI/UX Design', issuer: 'MySkill', date: '2023', image: '/certificates/introduction figma.png', description: 'Perancangan UI/UX, wireframing, dan prototyping sistem aplikasi.', type: 'Design' },
  { title: 'Figma Advanced Tools & Prototyping', issuer: 'MySkill', date: '2023', image: '/certificates/figmaa tools.png', description: 'Komponen UI interaktif, desain sistem, dan animasi prototyping tingkat lanjut di Figma.', type: 'Design' },
  { title: 'Internet Connection & Networking Basics', issuer: 'MySkill', date: '2023', image: '/certificates/internet connection.png', description: 'Dasar-dasar koneksi internet, protokol jaringan, dan arsitektur web.', type: 'Networking' },
  { title: 'Learn SQL & Aptitude Assessment', issuer: 'Codecademy', date: '2023', image: '/certificates/Aptitude Test.png', description: 'Sertifikasi manipulasi database relasional dan penguerian SQL tingkat mahir.', type: 'Database' },
];
