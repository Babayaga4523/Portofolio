...
const certificates = [
  ...
  const projects = [
    { title: 'Rental HS - Modern Car Rental App', desc: 'Aplikasi rental mobil modern dengan integrasi AI untuk rekomendasi personal. Menggunakan TypeScript, React 19, dan Vite untuk performa optimal. Fitur lengkap termasuk AI assistant, smart filtering, dan responsive design.', tech: ['TypeScript', 'React 19', 'Vite', 'Framer Motion', 'React Bootstrap', 'OpenRouter API'], images: ['/rental hs1.png', '/rental hs2.png', '/rental hs3.png', '/rental hs4.png', '/rental hs5.png', '/rental hs6.png', '/rental hs7.png', '/rental hs8.png', '/rental hs9.png', '/rental hs10.png'], link: 'https://rental-hs.vercel.app/' },
